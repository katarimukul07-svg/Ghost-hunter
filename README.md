...
- After every 10 completed rounds, the Garbage Collector trims old ghosts to 4 survivors, then 3, then 2, and finally 1 from round 40 onward.
...
| `GC_KEEP_START` | Echoes retained by the first collection |
| `GC_KEEP_MIN` | Minimum echoes retained by later collections |
